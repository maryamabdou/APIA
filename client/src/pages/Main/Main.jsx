          ...
          <div className="row gx-4 gx-lg-5 justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p className="text-white-75 mb-4">
                Unleash the power of AI in your job search! Meet APIA, the
                intelligent interview companion designed to elevate your
                performance and boost your confidence.
              </p>
            ...
            <div className="col-lg-3 col-md-6 text-center">
              <div className="mt-5">
                ...
                <p className="text-muted mb-0">
                  Experience the future of interaction. Engage with lifelike AI
                  avatars, indistinguishable from real humans
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 text-center">
              <div className="mt-5">
                ...
                <p className="text-muted mb-0">
                  Unlock deeper insights. Understand user behavior and optimize
                  experiences with real-time eye tracking
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 text-center">
              <div className="mt-5">
                ...
                <p className="text-muted mb-0">
                  Uncover hidden insights. Gain valuable customer sentiment
                  analysis through advanced facial emotional recognition.
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 text-center">
              <div className="mt-5">
                ...
                <p className="text-muted mb-0">
                  Evaluate interviews objectively: Score key attributes and
                  store data.
                </p>
              </div>
            </div>
          ...
          <div className="row g-0">
            <div className="col-lg-4 col-sm-6">
              <a
                ...
                href="src/pages/Man/assets/img/portfolio/thumbnails/1.jpg"
                title="APIA"
              >
            ...
            <div className="col-lg-4 col-sm-6">
              <a
                className="portfolio-box"
                href="src/pages/Man/assets/img/portfolio/fullsize/2.jpg"
                title="APIA"
              >
            ...
            <div className="col-lg-4 col-sm-6">
              <a
                className="portfolio-box"
                href="src/pages/Man/assets/img/portfolio/fullsize/3.jpg"
                title="APIA"
              >
          ...
          <div className="row gx-4 gx-lg-5 justify-content-center">
            <div className="col-lg-8 col-xl-6 text-center">
              ...
              <p className="text-muted mb-5">
                For any inquiries, send us a message, and we will get back to
